...
public:
    ...
    __host__ __device__ double residual(const double& reigv, const double& reigvs, SOL_VAR* flux);
    __host__ __device__ void axb(SOL_VAR* flux, SOL_VAR* aflux);
    __host__ __device__ double wiel(const int& icy, SOL_VAR* flux, double& eigv, double& reigv, double& reigvs);
