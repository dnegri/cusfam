...
sanm2n_reset(const int &lk, const int &ng, const int &ng2, int &nxyz, float *hmesh, double *xstf,
             double *xsdf, float *eta1, float *eta2, float *m260, float *m251, float *m253, float *m262,
...
__host__ __device__ void
sanm2n_resetMatrix(const int &lk, const int &ng, const int &ng2, int &nxyz, double &reigv, double *xstf,
                   double *xsnff, double *xschif, double *xssf, float *matMs, float *matMf,
                   float *matM) {
    int lkg0 = lk * ng;
...
sanm2n_calculateJnet(const int &ls, const int &ng, const int &ng2, int &nsurf, int *lklr, int *idirlr, int *sgnlr,
                     float *albedo, float *hmesh, double *xsadf, float *m251, float *m253, float *m260,
...
sanm2n_calculateJnet2n(const int &ls, const int &ng, const int &ng2, int &nsurf, int *lklr, int *idirlr, int *sgnlr,
                       float *hmesh, double *xsadf, float *m260, float *m262, float *m264, float *diagD,
...
sanm2n_calculateJnet1n(const int &ls, const int &lr, const int &ng, const int &ng2, int &nsurf, int *lklr, int *idirlr,
                       int *sgnlr, float *hmesh, const float &alb, double *xsadf, float *m251, float *m253,
