...
public:
    ...
    __host__ __device__ void minv(const int& l, double* cc, double* b, double* x);
    ...
    __host__ __device__ double& alpha() { return _calpha; }

    __host__ __device__ double& beta() { return _cbeta; }

    __host__ __device__ double& rho() { return _crho; }

    __host__ __device__ double& omega() { return _comega; }
    ...
    double& vr(int ig, int l) { return _vr[(l * _g->ng()) + ig]; };

    double& vr0(int ig, int l) { return _vr0[(l * _g->ng()) + ig]; };

    double& vp(int ig, int l) { return _vp[(l * _g->ng()) + ig]; };

    double& vv(int ig, int l) { return _vv[(l * _g->ng()) + ig]; };
