...
#
#
# class SnapshotTableWidget(unitTable.unitTableWidget):
#     def __init__(self, frame, headerItem, tableItemFormat, number_input=4, number_output=2, number_rod=0):
...
#         self.Snapshot_tableWidget_button01 = QPushButton(self.frame)
#         self.Snapshot_tableWidget_button02 = QPushButton(self.frame)
#         self.Snapshot_tableWidget_button03 = QPushButton(self.frame)
#         # self.Snapshot_tableWidget_button03 = QPushButton(self.frame)
#
#         self.makeButton()
...
#         return self.Snapshot_tableWidget_button01, self.Snapshot_tableWidget_button02, self.Snapshot_tableWidget_button03
#
#     def makeButton(self):
...
#
#         self.Snapshot_tableWidget_button01.setObjectName(u"Snapshot_tableWidget_button01")
#         self.Snapshot_tableWidget_button01.setMinimumSize(QSize(110, 24))
#         spinBox_DoubleSpinBox = df.styleSheet_Table_DoubleSpinBox
#         self.Snapshot_tableWidget_button01.setStyleSheet(spinBox_DoubleSpinBox)
#         self.tableButtonLayout.addWidget(self.Snapshot_tableWidget_button01)
#
#         self.Snapshot_tableWidget_button02.setObjectName(u"Snapshot_tableWidget_button02")
#         self.Snapshot_tableWidget_button02.setMinimumSize(QSize(110, 24))
#         self.Snapshot_tableWidget_button02.setStyleSheet(spinBox_DoubleSpinBox)
#
#         self.tableButtonLayout.addWidget(self.Snapshot_tableWidget_button02)
#
#         self.Snapshot_tableWidget_button03.setObjectName(u"Snapshot_tableWidget_button03")
#         self.Snapshot_tableWidget_button03.setMinimumSize(QSize(110, 24))
#         self.Snapshot_tableWidget_button03.setStyleSheet(spinBox_DoubleSpinBox)
#
#         self.tableButtonLayout.addWidget(self.Snapshot_tableWidget_button03)
#         self.Snapshot_tableWidget_button01.setText(QCoreApplication.translate("unitWidget_SD", u"Import", None))
#         self.Snapshot_tableWidget_button02.setText(QCoreApplication.translate("unitWidget_SD", u"Save as Excel", None))
#         self.Snapshot_tableWidget_button03.setText(QCoreApplication.translate("unitWidget_SD", u"Select", None))
#
#     def changeButtonText(self,accept,reject):
#
#         self.Snapshot_tableWidget_button02.setText(QCoreApplication.translate("unitWidget_SD", accept, None))
#         self.Snapshot_tableWidget_button03.setText(QCoreApplication.translate("unitWidget_SD", reject, None))
#
#     def add_table_array(self,table_array):
#
#
...
#         self.setRowCount(0)
#         # print("TEST")
#         # print(len(self.tableColumnHeaderItem))
...
#             a = "%3d" % (iStep + 1)
#
#             #self.tableColumnHeaderItem[iStep].setText(a)
#         #
...
#
#         # self.Snapshot_tableWidget_button01.clicked['bool'].connect(self.clickSaveAsExcel)
#         # self.Snapshot_tableWidget_button02.clicked['bool'].connect(self.resetPositionData)
#
...
class SnapshotTableWidget(unitTable.unitTableWidget):
    ...
    def make_table_array(self, table_array):
        self.table_array = []
        nStep = len(table_array)
        for idx in range(nStep):
            self.table_array.append(table_array[idx])

        # Reset TableWidget for initialize table, and Redefine Row number
        self.setRowCount(0)
        self.setRowCount(nStep)
